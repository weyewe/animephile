...
class Comic < ActiveRecord::Base
  ...
  # Comic.create_and_parse_images('My Mother',  'http://www.animephile.com/hentai/my-mother.html?ch=Volume+01',  3)
  ...
  def create_pages( images ) 
    ...
    images.each do |  image_url |
      ...
      Page.create :comic_id => self.id, :page_number => page_number, 
